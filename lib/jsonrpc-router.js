...
function JSONRPCRouter(parentRouter, options, apiVersion) {
	var self = this;
	this.apiVersion = apiVersion;
	this.apiType = 'jsonrpc';
	if(!options) options = {};
	...
	parentRouter.use('/rpc', this.mainRouter);

	this.callInfo = {};
}

JSONRPCRouter.prototype.getCallInfo = function() {
...
JSONRPCRouter.prototype.registerAPICall = function() {
	...
	this.callInfo[callData.name] = callData;
	return callData;
};
...
JSONRPCRouter.prototype.handleRPCRequest = function(req, res, next, data) {
	...
	req.apiVersion = rpcRouter.apiVersion;
